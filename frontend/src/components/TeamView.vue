<template>
  <div class="w-full max-w-7xl mx-auto px-4">
    <div class="flex justify-center mb-16 space-x-4">
      ...
      <BaseButton type="primary" class="p-3! text-sm!" @click="$emit('changeSection', 'about')">
        About Course >
      </BaseButton>
    </div>

    <h2
      class="text-6xl font-bold text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400"
    >
      ...
      >
        <div class="relative z-10 flex flex-col items-center">
          ...
          <div class="relative w-14 h-14 mb-4">
            <!-- Default Avatar -->
            <div
              class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-400 rounded-2xl rotate-45 flex items-center justify-center transform group-hover:rotate-0 transition-transform duration-500"
            >
              <span
                class="text-lg font-bold text-white -rotate-45 transform group-hover:rotate-0 transition-transform duration-500"
              >
