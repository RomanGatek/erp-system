<template>
    <div class="max-h-[75dvh] overflow-y-auto">
        <div class="bg-white rounded-2xl shadow-md flex flex-col shopping-cart">
            <div class="p-5">
                <h2
                ...
                <div v-if="cartItems.length === 0" class="flex flex-col items-center justify-center py-8 gap-4">
                ...
                <div v-else>
                        ...
                        <div v-for="item in cartItems" :key="item.id"
                            ...
                            <div class="flex-grow min-w-0">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-[0.8rem] font-semibold">{{ formatPrice(item.buyoutPrice ||
                                        item.price) }} Kč,-</span>
                    ...
                    <div class="border-t border-gray-200 pt-4 mt-2">
                        ...
                        <div class="flex justify-end gap-2">
                            <BaseButton type="primary" class="w-full text-sm!" @click="goToCheckout">
                                Checkout
                            </BaseButton>
                            <BaseButton type="error" class="w-full text-sm!" @click="clearCart">
                                Clear Cart
                            </BaseButton>
                        </div>
                    </div>
...
export default {
    ...
    setup() {
        ...
        const clearCart = () => {
            // Vymaže košík pomocí metody clearCart nebo clearItems z cart store
            if (typeof cart.clearCart === 'function') {
                cart.clearCart()
            } else if (typeof cart.clearItems === 'function') {
                cart.clearItems()
            }
        }
