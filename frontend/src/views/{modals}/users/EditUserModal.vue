    ...
    <div class="space-y-4">
      ...
      <div class="bg-gray-50/50 rounded-lg p-4 space-y-3">
        ...
        <div class="grid grid-cols-2 gap-3">
          <BaseInput v-model="user.firstName" placeholder="First Name" label="First name" :error="errors.firstName"
            class="text-sm" />
          <BaseInput v-model="user.lastName" placeholder="Last Name" label="Last name" :error="errors.lastName"
            class="text-sm" />
        </div>
        <BaseInput v-model="user.email" type="email" placeholder="Email" label="Email" :error="errors.email"
          class="text-sm" />
      </div>
      ...
      <div class="bg-gray-50/50 rounded-lg p-4 space-y-3">
        ...
        <BaseInput v-model="user.username" placeholder="Username" label="Username" :error="errors.username"
          class="text-sm" />
      ...
      <div class="flex justify-end gap-3 pt-4">
        ...
        <BaseButton type="primary" class="px-4!" @click="handleUpdateUser">
          Update User
        </BaseButton>
      </div>
    </div>
