...
public class OrderServiceTest {
    ...
    void testCancelOrderDoesNotChangeStatusWhenOrderIsNotPending() {
        testOrder.setStatus(Order.Status.PROCESSING); // Zmena stavu na COMPLETED
        Long orderId = 1L;
        ...
        assertEquals(Order.Status.PROCESSING, testOrder.getStatus()); // Stav objednávky zostáva nezmenený
