...
class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        // Orders
        Order orderOne = new Order(null, productOne, 2, 200.00, Order.Status.ORDERED, orderDateOne);
        Order orderTwo = new Order(null, productTwo, 5, 1000.00, Order.Status.ORDERED, orderDateTwo);
